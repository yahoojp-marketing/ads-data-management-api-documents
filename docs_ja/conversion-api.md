# Conversion API
LINEヤフー広告 ディスプレイ広告 コンバージョン計測API

> [!IMPORTANT]
> LINEヤフー広告のConversion APIとLINE Conversion APIを統合した、より精度の高いAPIも提供しています。新規で導入する場合は、新しいAPIのご利用をおすすめします。なお、LINEヤフー広告のConversion APIは今後提供終了を予定しております。提供終了時期については決まり次第お知らせいたします。  
...
| `hashed_phone_number` **        | string   | ハイフンやスペース等を含まないE.164形式の電話番号をSHA-256でハッシュ化した値。半角小文字英数字で入力してください。                                                                                    | `c9fb9ae95bff879cbcdfc9edf6716640bc40841f3b7352140daa1431af4c319e`  ( 日本の電話番号 `090-0123-4567` の場合、 `+819001234567` に変換し、その後SHA-256でハッシュ化してください。 ) |
...
| `yjr_yjad` **                   | string   | 広告をクリックしたユーザーを識別するパラメータ。 Cookie `_yjr_yjad` の値を入力してください。                                                                                           | `1600000000.123`                                                                                                                                  |
...
-d '{
    ...
    "hashed_phone_number": "c9fb9ae95bff879cbcdfc9edf6716640bc40841f3b7352140daa1431af4c319e",
    "yclid": "YJAD.1234567890.1EALEzSJBNabcdEFGBE1",
    "yjr_yjad": "1600000000.123",
