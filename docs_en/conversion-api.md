...
| `hashed_phone_number` **        | string   | Hashed phone number in E.164 format without hyphens or spaces using SHA-256. Use lower case alphanumeric characters.                                                                                                                                                                                                  | `c9fb9ae95bff879cbcdfc9edf6716640bc40841f3b7352140daa1431af4c319e` ( For a Japanese phone number such as 090-0123-4567, please convert it to +819001234567 and then hash it using SHA-256. ) |
...
| `yjr_yjad` **                   | string   | Parameter to identify users who have clicked ads. Use the value of `_yjr_yjad` Cookie.                                                                                                                                                                                                                                | `1600000000.123`                                                                                                                                                                             |
